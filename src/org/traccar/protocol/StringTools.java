    ...
    public static byte[] getBytes(String s) {
        if (s != null) {
            try {
                ...
                // will not occur
                Log.error("Charset not found: " + StringTools.getCharacterEncoding());
                return s.getBytes();
            }
        } else {
            return null;
    ...
    public static boolean isAlphaNumeric(String s, char... x) {
        if ((s == null) || s.equals("")) {
            ...
            for (int i = 0; i < ch.length; i++) {
                if (Character.isLetterOrDigit(ch[i])) {
                    continue;
                } else if ((x != null) && Arrays.asList(x).contains(ch[i])) {
                    continue;
                }
                return false;
            }
    ...
    public static String toStringValue(byte b[], int ofs, int len) {
        if (b == null) {
            ...
            try {
                ...
                Log.error("Byte=>String conversion error" + t);
                try {
    ...
    */
    ...
    public static BigInteger parseBigInteger(Object data, BigInteger dft) {
        if (data == null) {
            ...
            return BigInteger.valueOf(((DateTime) data).getMillis());
        } else {
            ...
            if ((this.numStr != null) && (this.type != null)) {
                try {
                    if (Byte.class.equals(this.type)) {
                        ...
                        Log.error("Unkrecognized Number type: " + StringTools.className(this.type));
                        return dft;
                    }
                } catch (NumberFormatException nfe) {
                    // should not occur
                    Log.error("Number conversion error" + nfe);
                    return dft;
                }
            }
            return dft;
    ...
    public static String[] parseArray(String s, char arrayDelim) {
        ...
        char ch[] = new char[len];
        s.getChars(0, len, ch, 0);
        java.util.List<String> v = new Vector<>();
        for (int a = 0; ; ) {
            if (a >= len) {
    ...
    public static String encodeArray(java.util.List<Object> list) {
        return StringTools.encodeArray(list.toArray(), ARRAY_DELIM, true);
    }
    ...
    public static String encodeArray(java.util.List<Object> list, boolean alwaysQuote) {
        return StringTools.encodeArray(list.toArray(), ARRAY_DELIM, alwaysQuote);
    }
